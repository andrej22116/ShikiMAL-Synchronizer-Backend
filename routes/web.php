...
$router->group(['prefix' => 'myanimelist', 'namespace' => 'MyAnimeList'], function() use($router) {
    // Auth
    $router->group(['prefix' => 'auth', 'middleware' => 'cookie_response'], function() use($router) {
    ...
    $router->group(['middleware' => ['mal_auth', 'cookie_response']], function() use($router) {
        // User endpoints
...
$router->group(['prefix' => 'shikimori', 'namespace' => 'Shikimori'], function() use($router) {
    ...
    // Api for authorized users
    $router->group(['middleware' => ['shikimori_auth', 'cookie_response']], function() use($router) {
        // User endpoints
        $router->group(['prefix' => 'user'], function() use($router) {
